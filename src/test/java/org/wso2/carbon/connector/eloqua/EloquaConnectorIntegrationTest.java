...
public class EloquaConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void setEnvironment() throws Exception {
        ...
        init("eloqua-connector-1.0.1-SNAPSHOT");
        ...
        String authHeader = connectorProperties.getProperty("siteName") + "\\" + connectorProperties.getProperty
                ("username") + ":" + connectorProperties.getProperty("password");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFieldsWithMandatoryParameters"},
            description = "eloqua {getContactFields} integration test with optional parameters.")
    public void testGetContactFieldsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getContactFields";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/fields?totalResults=" + connectorProperties.
                        getProperty("totalResults") + "&q=" + connectorProperties.getProperty("q") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactFieldsOptional.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFieldsWithOptionalParameters"},
            description = "eloqua {getContactFieldById} integration test with mandatory parameters.")
    public void testGetContactFieldByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "contacts/fields/" + connectorProperties.
                getProperty("contactFieldId");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactFieldById.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFieldByIdWithMandatoryParameters"},
            description = "eloqua {getContactFieldById} integration test with mandatory parameters.")
    public void testGetContactFieldByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getContactFieldById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactFieldByIdNegative.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFieldByIdWithNegativeCase"},
            description = "eloqua {getContactFilters} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFiltersWithMandatoryParameters"},
            description = "eloqua {getContactFilters} integration test with optional parameters.")
    public void testGetContactFiltersWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getContactFilters";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/filters?totalResults=" +
                        connectorProperties.getProperty("totalResults") + "&q=" + connectorProperties.getProperty("q") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactFiltersOptional.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFiltersWithOptionalParameters"},
            description = "eloqua {getContactFilterById} integration test with mandatory parameters.")
    public void testGetContactFilterByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "contacts/filters/" +
                connectorProperties.getProperty("contactFilterId");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactFilterById.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFilterByIdWithMandatoryParameters"},
            description = "eloqua {getContactFilterById} integration test with negative case.")
    public void testGetContactFilterByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getContactFilterById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactFilterByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactFilterByIdWithNegativeCase"},
            description = "eloqua {getContactLists} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactListsWithMandatoryParameters"},
            description = "eloqua {getContactLists} integration test with optional parameters.")
    public void testGetContactListsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getContactLists";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/lists?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactListsOptional.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactListsWithOptionalParameters"},
            description = "eloqua {getContactListById} integration test with mandatory parameters.")
    public void testGetContactListByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "contacts/lists/" +
                connectorProperties.getProperty("contactListId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactListByIdWithMandatoryParameters"},
            description = "eloqua {getContactListById} integration test with negative case.")
    public void testGetContactListByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getContactListById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactListByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactListByIdWithNegativeCase"},
            description = "eloqua {getContactSegments} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactSegmentsWithMandatoryParameters"},
            description = "eloqua {getContactSegments} integration test with optional parameters.")
    public void testGetContactSegmentsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getContactSegments";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/segments?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactSegmentsOptional.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactSegmentsWithOptionalParameters"},
            description = "eloqua {getContactSegmentById} integration test with mandatory parameters.")
    public void testGetContactSegmentByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "contacts/segments/" +
                connectorProperties.getProperty("contactSegmentId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactSegmentByIdWithMandatoryParameters"},
            description = "eloqua {getContactSegmentById} integration test with mandatory parameters.")
    public void testGetContactSegmentByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getContactSegmentById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactSegmentByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactSegmentByIdWithNegativeCase"},
            description = "eloqua {getContactImports} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactImportsWithMandatoryParameters"},
            description = "eloqua {getContactImports} integration test with optional parameters.")
    public void testGetContactImportsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getContactImports";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/imports?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactImportsOptional.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactImportsWithOptionalParameters"},
            description = "eloqua {getContactExports} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactExportsWithMandatoryParameters"},
            description = "eloqua {getContactExports} integration test with optional parameters.")
    public void testGetContactExportsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getContactExports";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/exports?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactExportsOptional.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactExportsWithOptionalParameters"},
            description = "eloqua {createContactExport} integration test with mandatory parameter.")
    public void testCreateContactExportWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/exports/" +
                        connectorProperties.getProperty("contactExportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateContactExportWithMandatoryParameters"},
            description = "eloqua {updateContactExport} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateContactExportWithMandatoryParameters"},
            description = "eloqua {getContactExportById} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactExportByIdWithMandatoryParameters"},
            description = "eloqua {getContactExportById} integration test with negative case.")
    public void testGetContactExportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getContactExportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactExportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactExportByIdWithNegativeCase"},
            description = "eloqua {getContactExportDataById} integration test with mandatory parameters.")
    public void testGetContactExportDataByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "contacts/exports/" +
                connectorProperties.getProperty("contactExportId") + "/data";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactExportDataById.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactExportDataByIdWithMandatoryParameters"},
            description = "eloqua {getContactExportDataById} integration test with negative case.")
    public void testGetContactExportDataByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getContactExportDataById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactExportDataByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactExportDataByIdWithNegativeCase"},
            description = "eloqua {createContactImport} integration test with mandatory parameter.")
...
//        connectorProperties.put("syncedInstanceUri", importUri);
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/imports/" +
                        connectorProperties.getProperty("contactImportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateContactImportWithMandatoryParameters"},
            description = "eloqua {createContactImportData} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateContactImportDataWithMandatoryParameters"},
            description = "eloqua {updateContactImport} integration test with mandatory parameter.")
    public void testUpdateContactImportWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "contacts/imports/" + connectorProperties.
                        getProperty("contactImportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateContactImportWithMandatoryParameters"},
            description = "eloqua {getContactImportById} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactImportByIdWithMandatoryParameters"},
            description = "eloqua {getContactImportById} integration test with negative case.")
    public void testGetContactImportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getContactImportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getContactImportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetContactImportByIdWithNegativeCase"},
            description = "eloqua {getEmailGroups} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetEmailGroupsWithMandatoryParameters"},
            description = "eloqua {getEmailGroups} integration test with optional parameters.")
    public void testGetEmailGroupsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getEmailGroups";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "emailGroups/?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetEmailGroupsWithOptionalParameters"},
            description = "eloqua {getEmailGroupById} integration test with mandatory parameters.")
    public void testGetEmailGroupByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "emailGroups/" +
                connectorProperties.getProperty("emailGroupId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetEmailGroupByIdWithMandatoryParameters"},
            description = "eloqua {getEmailGroupById} integration test with negative case.")
    public void testGetEmailGroupByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getEmailGroupById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getEmailGroupByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetEmailGroupByIdWithNegativeCase"},
            description = "eloqua {getExports} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetExportsWithMandatoryParameters"},
            description = "eloqua {getExports} integration test with optional parameters.")
    public void testGetExportsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getExports";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "exports/?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetExportsWithOptionalParameters"},
            description = "eloqua {getExportsData} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetExportsDataWithMandatoryParameters"},
            description = "eloqua {getImports} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetImportsWithMandatoryParameters"},
            description = "eloqua {getImports} integration test with optional parameters.")
    public void testGetImportsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getImports";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "imports/?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetImportsWithOptionalParameters"},
            description = "eloqua {getImportsData} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetImportsDataWithMandatoryParameters"},
            description = "eloqua {createSync} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateSyncWithMandatoryParameters"},
            description = "eloqua {getSyncs} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncsWithMandatoryParameters"},
            description = "eloqua {getSyncs} integration test with optional parameters.")
    public void testGetSyncsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getSyncs";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "syncs/?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncsWithOptionalParameters"},
            description = "eloqua {getSyncById} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncByIdWithMandatoryParameters"},
            description = "eloqua {getSyncById} integration test with negative case.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncByIdWithNegativeCase"},
            description = "eloqua {getSyncsLogsById} integration test with mandatory parameters.")
    public void testGetSyncsLogsByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "syncs/" +
                connectorProperties.getProperty("syncId") + "/logs";
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncsLogsByIdWithMandatoryParameters"},
            description = "eloqua {getSyncsLogsById} integration test with optional parameters.")
    public void testGetSyncsLogsByIdWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getSyncsLogsById";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "syncs/" + connectorProperties.getProperty("syncId") +
                        "/logs?totalResults=" + connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getSyncsLogsByIdOptional.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        System.out.println(apiRestResponse.getBody().toString());
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncsLogsByIdWithOptionalParameters"},
            description = "eloqua {getSyncsRejectsById} integration test with mandatory parameters.")
    public void testGetSyncsRejectsByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "syncs/" + connectorProperties.
                getProperty("syncId") + "/rejects";
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncsRejectsByIdWithMandatoryParameters"},
            description = "eloqua {getSyncsRejectsById} integration test with optional parameters.")
    public void testGetSyncsRejectsByIdWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getSyncsRejectsById";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "syncs/" + connectorProperties.getProperty("syncId") +
                        "/rejects?totalResults=" + connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getSyncsRejectsByIdOptional.json");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncsRejectsByIdWithOptionalParameters"},
            description = "eloqua {getSyncsDataById} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetSyncsDataByIdWithMandatoryParameters"},
            description = "eloqua {createAccountExport} integration test with mandatory parameter.")
    public void testCreateAccountExportWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "accounts/exports/" +
                        connectorProperties.getProperty("accountExportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateAccountExportWithMandatoryParameters"},
            description = "eloqua {updateAccountExport} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateAccountExportWithMandatoryParameters"},
            description = "eloqua {getAccountExportById} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountExportByIdWithMandatoryParameters"},
            description = "eloqua {getAccountExportById} integration test with negative case.")
    public void testGetAccountExportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getAccountExportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getAccountExportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountExportByIdWithNegativeCase"},
            description = "eloqua {getAccountExportDataById} integration test with mandatory parameters.")
    public void testGetAccountExportDataByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "accounts/exports/" +
                connectorProperties.getProperty("accountExportId") + "/data";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getAccountExportDataById.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountExportDataByIdWithMandatoryParameters"},
            description = "eloqua {getAccountExportDataById} integration test with negative case.")
    public void testGetAccountExportDataByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getAccountExportDataById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getAccountExportDataByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountExportDataByIdWithNegativeCase"},
            description = "eloqua {createAccountImport} integration test with mandatory parameter.")
    public void testCreateAccountImportWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "accounts/imports/" + connectorProperties.
                        getProperty("accountImportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateAccountImportWithMandatoryParameters"},
            description = "eloqua {createAccountImportData} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateAccountImportDataWithMandatoryParameters"},
            description = "eloqua {updateAccountImport} integration test with mandatory parameter.")
    public void testUpdateAccountImportWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "accounts/imports/" +
                        connectorProperties.getProperty("accountImportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateAccountImportWithMandatoryParameters"},
            description = "eloqua {getAccountImportById} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountImportByIdWithMandatoryParameters"},
            description = "eloqua {getAccountImportById} integration test with negative case.")
    public void testGetAccountImportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getAccountImportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getAccountImportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountImportByIdWithNegativeCase"},
            description = "eloqua {getAccountFields} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountFieldsWithMandatoryParameters"},
            description = "eloqua {getAccountFields} integration test with optional parameters.")
    public void testGetAccountFieldsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getAccountFields";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "accounts/fields?totalResults=" +
                        connectorProperties.getProperty("totalResults") + "&q=" + connectorProperties.getProperty("q") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountFieldsWithOptionalParameters"},
            description = "eloqua {getAccountFieldById} integration test with mandatory parameters.")
    public void testGetAccountFieldByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "accounts/fields/" +
                connectorProperties.getProperty("accountFieldId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountFieldByIdWithMandatoryParameters"},
            description = "eloqua {getAccountFieldById} integration test with mandatory parameters.")
    public void testGetAccountFieldByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getAccountFieldById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getAccountFieldByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountFieldByIdWithNegativeCase"},
            description = "eloqua {getAccountLists} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountListsWithMandatoryParameters"},
            description = "eloqua {getAccountLists} integration test with optional parameters.")
    public void testGetAccountListsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getAccountLists";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "accounts/lists?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountListsWithOptionalParameters"},
            description = "eloqua {getAccountListById} integration test with mandatory parameters.")
    public void testGetAccountListByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "accounts/lists/" +
                connectorProperties.getProperty("accountListId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountListByIdWithMandatoryParameters"},
            description = "eloqua {getAccountListById} integration test with negative case.")
    public void testGetAccountListByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getAccountListById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getAccountListByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountListByIdWithNegativeCase"},
            description = "eloqua {getAccountImports} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountImportsWithMandatoryParameters"},
            description = "eloqua {getAccountImports} integration test with optional parameters.")
    public void testGetAccountImportsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getAccountImports";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "accounts/imports?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountImportsWithOptionalParameters"},
            description = "eloqua {getAccountExports} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountExportsWithMandatoryParameters"},
            description = "eloqua {getAccountExports} integration test with optional parameters.")
    public void testGetAccountExportsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getAccountExports";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "accounts/exports?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetAccountExportsWithOptionalParameters"},
            description = "eloqua {createActivityExport} integration test with mandatory parameter.")
    public void testCreateActivityExportWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "activities/exports/" + connectorProperties.
                        getProperty("activityExportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateActivityExportWithMandatoryParameters"},
            description = "eloqua {updateActivityExport} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateActivityExportWithMandatoryParameters"},
            description = "eloqua {getActivityExportById} integration test with mandatory parameters.")
    public void testGetActivityExportByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "activities/exports/" +
                connectorProperties.getProperty("activityExportId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityExportByIdWithMandatoryParameters"},
            description = "eloqua {getActivityExportById} integration test with negative case.")
    public void testGetActivityExportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getActivityExportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getActivityExportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityExportByIdWithNegativeCase"},
            description = "eloqua {getActivityExportDataById} integration test with mandatory parameters.")
    public void testGetActivityExportDataByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "activities/exports/" +
                connectorProperties.getProperty("activityExportId") + "/data";
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityExportDataByIdWithMandatoryParameters"},
            description = "eloqua {getActivityExportDataById} integration test with negative case.")
    public void testGetActivityExportDataByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getActivityExportDataById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getActivityExportDataByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityExportDataByIdWithNegativeCase"},
            description = "eloqua {createActivityImport} integration test with mandatory parameter.")
    public void testCreateActivityImportWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "activities/imports/" + connectorProperties.
                        getProperty("activityImportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateActivityImportWithMandatoryParameters"},
            description = "eloqua {createActivityImportData} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateActivityImportDataWithMandatoryParameters"},
            description = "eloqua {updateActivityImport} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateActivityImportWithMandatoryParameters"},
            description = "eloqua {getActivityImportById} integration test with mandatory parameters.")
    public void testGetActivityImportByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "activities/imports/" +
                connectorProperties.getProperty("activityImportId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityImportByIdWithMandatoryParameters"},
            description = "eloqua {getActivityImportById} integration test with negative case.")
    public void testGetActivityImportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getActivityImportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getActivityImportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityImportsWithMandatoryParameters"},
            description = "eloqua {getActivityImports} integration test with optional parameters.")
    public void testGetActivityImportsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getActivityImports";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "activities/imports?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityImportsWithOptionalParameters"},
            description = "eloqua {getActivityTypes} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityTypesWithMandatoryParameters"},
            description = "eloqua {getActivityTypes} integration test with optional parameters.")
    public void testGetActivityTypesWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getActivityTypes";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "activities/types?totalResults=" +
                        connectorProperties.getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityTypesWithOptionalParameters"},
            description = "eloqua {getActivityTypeById} integration test with mandatory parameters.")
    public void testGetActivityTypeByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "activities/types/" +
                connectorProperties.getProperty("activityTypeId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityTypeByIdWithMandatoryParameters"},
            description = "eloqua {getActivityTypeById} integration test with negative case.")
    public void testGetActivityTypeByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getActivityTypeById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getActivityTypeByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetActivityTypeByIdWithNegativeCase"},
            description = "eloqua {createCustomObjectExport} integration test with mandatory parameter.")
    public void testCreateCustomObjectExportWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "createCustomObjectExport.json");
        String exportUri = esbRestResponse.getBody().get("uri").toString();
        String exportId = exportUri.substring(25, exportUri.length());
        connectorProperties.put("customObjectExportId", exportId);
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                        getProperty("customObjectId") + "/exports/" + connectorProperties.getProperty("customObjectExportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateCustomObjectExportWithMandatoryParameters"},
            description = "eloqua {updateCustomObjectExport} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateCustomObjectExportWithMandatoryParameters"},
            description = "eloqua {getCustomObjectExportById} integration test with mandatory parameters.")
    public void testGetCustomObjectExportByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                getProperty("customObjectId") + "/exports/" + connectorProperties.getProperty("customObjectExportId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectExportByIdWithMandatoryParameters"},
            description = "eloqua {getCustomObjectExportById} integration test with negative case.")
    public void testGetCustomObjectExportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getCustomObjectExportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getCustomObjectExportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectExportByIdWithNegativeCase"},
            description = "eloqua {getCustomObjectExportDataById} integration test with mandatory parameters.")
    public void testGetCustomObjectExportDataByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getCustomObjectExportDataById.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectExportDataByIdWithMandatoryParameters"},
            description = "eloqua {getCustomObjectExportDataById} integration test with negative case.")
    public void testGetCustomObjectExportDataByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getCustomObjectExportDataById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getCustomObjectExportDataByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectExportDataByIdWithNegativeCase"},
            description = "eloqua {createCustomObjectImport} integration test with mandatory parameter.")
    public void testCreateCustomObjectImportWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "createCustomObjectImport.json");
        String importUri = esbRestResponse.getBody().get("uri").toString();
        String importId = importUri.substring(25, importUri.length());
        connectorProperties.put("customObjectImportId", importId);
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                        getProperty("customObjectId") + "/imports/" + connectorProperties.getProperty("customObjectImportId");
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateCustomObjectImportWithMandatoryParameters"},
            description = "eloqua {createCustomObjectImportData} integration test with mandatory parameter.")
    public void testCreateCustomObjectImportDataWithMandatoryParameters() throws IOException, JSONException {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "createCustomObjectImportData.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 204);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testCreateCustomObjectImportDataWithMandatoryParameters"},
            description = "eloqua {updateCustomObjectImport} integration test with mandatory parameter.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testUpdateCustomObjectImportWithMandatoryParameters"},
            description = "eloqua {getCustomObjectImportById} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectImportByIdWithMandatoryParameters"},
            description = "eloqua {getCustomObjectImportById} integration test with negative case.")
    public void testGetCustomObjectImportByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getCustomObjectImportById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getCustomObjectImportByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectImportByIdWithNegativeCase"},
            description = "eloqua {getCustomObjects} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectsWithMandatoryParameters"},
            description = "eloqua {getCustomObjects} integration test with optional parameters.")
    public void testGetCustomObjectsWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getCustomObjects";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "customObjects?totalResults=" + connectorProperties.
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectsWithOptionalParameters"},
            description = "eloqua {getCustomObjectById} integration test with mandatory parameters.")
    public void testGetCustomObjectByIdWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "customObjects/" +
                connectorProperties.getProperty("customObjectId");
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectByIdWithMandatoryParameters"},
            description = "eloqua {getCustomObjectById} integration test with negative case.")
    public void testGetCustomObjectByIdWithNegativeCase() throws IOException, JSONException {
        String methodName = "getCustomObjectById";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getCustomObjectByIdNegative.json");
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 404);
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetCustomObjectByIdWithNegativeCase"},
            description = "eloqua {getExportsOfCustomObject} integration test with mandatory parameters.")
    public void testGetExportsOfCustomObjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "customObjects/" +
                connectorProperties.getProperty("customObjectId") + "/exports";
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetExportsOfCustomObjectWithMandatoryParameters"},
            description = "eloqua {getExportsOfCustomObject} integration test with optional parameters.")
    public void testGetExportsOfCustomObjectWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getExportsOfCustomObject";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                        getProperty("customObjectId") + "/exports?totalResults=" + connectorProperties.
                        getProperty("totalResults") +
                        "&orderBy=" + connectorProperties.getProperty("orderByEncoded") + "&offset=" +
                        connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getExportsOfCustomObjectOptional.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetExportsOfCustomObjectWithOptionalParameters"},
            description = "eloqua {getImportsOfCustomObject} integration test with mandatory parameters.")
    public void testGetImportsOfCustomObjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                getProperty("customObjectId") + "/imports";
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getImportsOfCustomObject.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetImportsOfCustomObjectWithMandatoryParameters"},
            description = "eloqua {getImportsOfCustomObject} integration test with optional parameters.")
    public void testGetImportsOfCustomObjectWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getImportsOfCustomObject";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                        getProperty("customObjectId") + "/imports?totalResults=" + connectorProperties.
                        getProperty("totalResults") + "&orderBy=" + connectorProperties.getProperty("orderByEncoded") +
                        "&offset=" + connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.
                        getProperty("limit");
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(getProxyServiceURL(methodName), "POST", esbRequestHeadersMap,
                        "getImportsOfCustomObjectOptional.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetImportsOfCustomObjectWithOptionalParameters"},
            description = "eloqua {getFieldsOfCustomObject} integration test with mandatory parameters.")
    public void testGetFieldsOfCustomObjectWithMandatoryParameters() throws IOException, JSONException {
        ...
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                getProperty("customObjectId") + "/fields";
        RestResponse<JSONObject> esbRestResponse =
     ...
     */
    @Test(enabled = true, dependsOnMethods = {"testGetFieldsOfCustomObjectWithMandatoryParameters"},
            description = "eloqua {getFieldsOfCustomObject} integration test with optional parameters.")
    public void testGetFieldsOfCustomObjectWithOptionalParameters() throws IOException, JSONException {

        String methodName = "getFieldsOfCustomObject";
        String apiEndPoint =
                connectorProperties.getProperty("apiUrl") + "customObjects/" + connectorProperties.
                        getProperty("customObjectId") + "/fields?totalResults=" + connectorProperties.
                        getProperty("totalResults") + "&orderBy=" + connectorProperties.getProperty("orderByEncoded") +
                        "&offset=" + connectorProperties.getProperty("offset") + "&limit=" + connectorProperties.
                        getProperty("limit");
        RestResponse<JSONObject> esbRestResponse = sendJsonRestRequest(getProxyServiceURL(methodName), "POST",
                esbRequestHeadersMap, "getFieldsOfCustomObjectOptional.json");
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
        Assert.assertEquals(esbRestResponse.getBody().toString(), apiRestResponse.getBody().toString());
    }
     ...
     */
    @Test(enabled = false, dependsOnMethods = {"testGetFieldsOfCustomObjectWithOptionalParameters"},
            description = "eloqua {deleteContactExportData} integration test.")
     ...
     */
    @Test(enabled = false, dependsOnMethods = {"testDeleteContactExportDataWithMandatoryParameters"},
            description = "eloqua {deleteContactExport} integration test.")
     ...
     */
    @Test(enabled = false, dependsOnMethods = {"testDeleteContactExportWithMandatoryParameters"},
            description = "eloqua {deleteContactImportData} integration test.")
     ...
     */
    @Test(enabled = false, dependsOnMethods = {"testDeleteContactImportDataWithMandatoryParameters"},
            description = "eloqua {deleteContactImport} integration test.")
